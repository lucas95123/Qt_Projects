...
public:
    ...
    void setupUi(QDialog *DB_funct)
    {
        ...
        QIcon icon1;
        icon1.addFile(QStringLiteral(":/bmp/bmp/in.ico"), QSize(), QIcon::Normal, QIcon::Off);
        toolButton_in->setIcon(icon1);
        ...
        QIcon icon2;
        icon2.addFile(QString::fromUtf8(":/bmp/bmp/\345\233\276\345\203\217 5.bmp"), QSize(), QIcon::Normal, QIcon::Off);
        toolButton_borrow->setIcon(icon2);
        ...
        QIcon icon3;
        icon3.addFile(QStringLiteral(":/bmp/bmp/Add user.ico"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon4;
        icon4.addFile(QStringLiteral(":/bmp/bmp/search.ico"), QSize(), QIcon::Normal, QIcon::Off);
        toolButton_find->setIcon(icon4);
        ...
        QIcon icon5;
        icon5.addFile(QString::fromUtf8(":/bmp/bmp/\345\233\276\345\203\217 4.bmp"), QSize(), QIcon::Normal, QIcon::Off);
        toolButton_return->setIcon(icon5);
        ...
        QIcon icon6;
        icon6.addFile(QStringLiteral(":/bmp/bmp/Remove user.ico"), QSize(), QIcon::Normal, QIcon::Off);
        toolButton_del->setIcon(icon6);
