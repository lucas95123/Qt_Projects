...
public:
    ...
    void setupUi(QDialog *DB_in_dialog)
    {
        ...
        QIcon icon;
        icon.addFile(QStringLiteral(":/bmp/bmp/single in.ico"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon1;
        icon1.addFile(QStringLiteral(":/bmp/bmp/multi in.ico"), QSize(), QIcon::Normal, QIcon::Off);
